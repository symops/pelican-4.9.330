...
void (*pcie_write)(u32 addr, u8 size, u32 wval);
uint32_t (*pcie_read)(u32 addr, u8 size);
#endif
...
rtl8125_exit_oob(struct net_device *dev)
{
        ...
        case CFG_METHOD_5:
                ...
                rtl8125_mac_ocp_write(tp, 0xC0A6, 0x01A0);
...
rtl8125_set_mac_mcu_8125b_2(struct net_device *dev)
{
        ...
        static const u16 mcu_patch_code_8125b_2[] =  {
                0xE008, 0xE013, 0xE01E, 0xE02F, 0xE035, 0xE04F, 0xE051, 0xE053, 0x740A,
                ...
                0xC602, 0xBE00, 0x12DC, 0x733A, 0x21B5, 0x25BC, 0x1304, 0xF114, 0x1B12,
                ...
                0xC602, 0xBE00, 0x4A26, 0xC602, 0xBE00, 0x0000, 0xC602, 0xBE00, 0x0000,
        ...
        rtl8125_mac_ocp_write(tp, 0xFC48, 0x000F);
}
...
static const u16 phy_mcu_ram_code_8125b_2[] = {
        ...
        0xb820, 0x0090, 0xa436, 0xb87c, 0xa438, 0x8625, 0xa436, 0xb87e,
        0xa438, 0xaf86, 0xa438, 0x3daf, 0xa438, 0x8689, 0xa438, 0xaf86,
        0xa438, 0x89af, 0xa438, 0x8689, 0xa438, 0xaf86, 0xa438, 0x89af,
        0xa438, 0x8689, 0xa438, 0xaf86, 0xa438, 0x89af, 0xa438, 0x8689,
        0xa438, 0xbf86, 0xa438, 0x49d7, 0xa438, 0x0040, 0xa438, 0x0277,
        0xa438, 0x7daf, 0xa438, 0x2727, 0xa438, 0x0000, 0xa438, 0x7205,
        0xa438, 0x0000, 0xa438, 0x7208, 0xa438, 0x0000, 0xa438, 0x71f3,
        0xa438, 0x0000, 0xa438, 0x71f6, 0xa438, 0x0000, 0xa438, 0x7229,
        0xa438, 0x0000, 0xa438, 0x722c, 0xa438, 0x0000, 0xa438, 0x7217,
        0xa438, 0x0000, 0xa438, 0x721a, 0xa438, 0x0000, 0xa438, 0x721d,
        0xa438, 0x0000, 0xa438, 0x7211, 0xa438, 0x0000, 0xa438, 0x7220,
        0xa438, 0x0000, 0xa438, 0x7214, 0xa438, 0x0000, 0xa438, 0x722f,
        0xa438, 0x0000, 0xa438, 0x7223, 0xa438, 0x0000, 0xa438, 0x7232,
        0xa438, 0x0000, 0xa438, 0x7226, 0xa436, 0xb85e, 0xa438, 0x271E,
        ...
        0xb820, 0x0010, 0xa436, 0x0000, 0xa438, 0x0000, 0xa436, 0xB82E,
        0xa438, 0x0000, 0xa436, 0x8024, 0xa438, 0x0000, 0xb820, 0x0000,
        0xa436, 0x801E, 0xa438, 0x0003, 0xFFFF, 0xFFFF
};
...
rtl8125_hw_phy_config_8125b_2(struct net_device *dev)
{
        ...
        mdio_direct_write_phy_ocp(tp, 0xB87C, 0x760E);
        mdio_direct_write_phy_ocp(tp, 0xB87C, 0x8107);
        mdio_direct_write_phy_ocp(tp, 0xB87C, 0x360E);
                   ...
                   void __iomem **ioaddr_out)
{
	...
	if (pdev->bus->number == 0) {
		ioaddr = ioremap(0x9804f000, pci_resource_len(pdev, 2));
		pcie_write = rtk_pcie1_write;
		pcie_read = rtk_pcie1_read;
		rtk_pcie1_change_bar(pci_resource_start(pdev, 2));
	} else {
		ioaddr = ioremap(0x9803C000, pci_resource_len(pdev, 2));
		pcie_write = rtk_pcie2_write;
		pcie_read = rtk_pcie2_read;
		rtk_pcie2_change_bar(pci_resource_start(pdev, 2));
	}
#else
