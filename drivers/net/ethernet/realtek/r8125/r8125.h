...
#define RTL_W8(tp, reg, val8)   pcie_write(reg, 1, val8)
#define RTL_W16(tp, reg, val16) pcie_write(reg, 2, val16)
#define RTL_W32(tp, reg, val32) pcie_write(reg, 4, val32)
#define RTL_R8(tp, reg)     pcie_read(reg, 1)
#define RTL_R16(tp, reg)    pcie_read(reg, 2)
#define RTL_R32(tp, reg)    pcie_read(reg, 4)
