...
static struct clk_gate_data cc_gates[] = {
	GATE_CRITICAL(RTD1295_CRT_CLK_EN_MISC, "misc", NULL,  0x0C, 0),
	...
	GATE(RTD1295_CRT_CLK_EN_UR2, "ur2", "misc", 0x10, 27),
	GATE(RTD1295_CRT_CLK_EN_UR1, "ur1", "misc", 0x10, 28),
