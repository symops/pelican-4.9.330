...
#else
#define MEM_SLOT_PHYS_0 (0x02E00000)
#define MEM_SLOT_SIZE_0 (0x0D200000) // Max : 199M
#endif
...
#else
#define MEM_SLOT_PHYS_2 (0x12000000)
#define MEM_SLOT_SIZE_2 (0x0D500000) // Max : 166M
#endif
...
/* 0x22000000 ~ 0x00200000 */ //PSTORE : 2MB
#define PSTORE_MEM_PHYS	(0x22000000)

#ifdef CONFIG_PSTORE_RAM
#define PSTORE_MEM_SIZE	(0x00200000)
#else
#define PSTORE_MEM_SIZE	(0x00000000)
#endif
...
#define MEM_SLOT_PHYS_6 (0x50000000)
#define MEM_SLOT_SIZE_6 (0x10000000)
